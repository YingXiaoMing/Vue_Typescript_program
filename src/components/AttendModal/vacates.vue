        ...
        <a-row style="marginTop: 10px">
            <a-col :span="24">
                <a-form-item label="请假原因" v-bind="formItemLayout2">
                    <a-textarea :rows="4" :disabled="!data.isEdit" v-decorator="['reason', {initialValue: data.reason, rules: [{ required: true, message: ' ' }]}]"></a-textarea>
                </a-form-item>
            </a-col>
        </a-row>
        <a-row style="marginTop: 10px">
            <a-col :span="24">
                <a-form-item label="备注" v-bind="formItemLayout2">
                    <a-textarea :rows="4" :disabled="!data.isEdit" v-decorator="['note', {initialValue: data.note}]"></a-textarea>
                </a-form-item>
            </a-col>
        </a-row>
    </a-form>
