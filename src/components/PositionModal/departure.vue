      ...
      <a-row>
        <a-col :span="18">
            <a-form-item label="离职类型" v-bind="formItemLayout2">
                  ...
                  <a-input readonly v-else v-decorator="['employeePositionChangeTypeName', {initialValue: data.employeePositionChangeTypeName}]"></a-input>
            </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="18">
            <a-form-item label="生效日期" v-bind="formItemLayout2">
                  ...
                  <a-input readonly v-else v-decorator="['effectiveDate', { initialValue: data.effectiveDate }]"></a-input>   
            </a-form-item>
        </a-col>
      </a-row>
      <a-row>
