        ...
        <a-row>
            <a-col :span="12">
                <a-form-item label="工单号" v-bind="formItemLayout">
                    <a-input read-only v-decorator="['workOrderNumber', {initialValue: formModal.workOrderNumber}]"></a-input>
                </a-form-item>
            </a-col>
        </a-row>
        <a-row>
            <a-col :span="12">
                <a-form-item label="员工工号" v-bind="formItemLayout">
                    <a-input read-only v-decorator="['num', {initialValue: formModal.num}]"></a-input>
                </a-form-item>
            </a-col>
            <a-col :span="12">
                <a-form-item label="员工姓名" v-bind="formItemLayout">
                    <a-input read-only v-decorator="['name', {initialValue: formModal.name}]"></a-input>
                </a-form-item>
            </a-col>
            <a-col :span="12">
                <a-form-item label="奖励类型" v-bind="formItemLayout" v-if="formModal.type === 1">
                    ...
                    <a-input v-else read-only v-decorator="['typeName', {initialValue: formModal.prizePenaltyTypeId.label}]"></a-input>
                </a-form-item>
            ...
            <a-col :span="12">
                <a-form-item  label="执行日期" v-bind="formItemLayout">
                    ...
                    <a-input v-else read-only v-decorator="['effectiveDate', {initialValue: formModal.effectiveDate}]"></a-input>
                </a-form-item>
        ...
        <a-row :gutter="24">
            <a-col :span="24">
                <a-form-item label="情况描述" v-bind="formItemLayout2">
                    <a-textarea :read-only="!formModal.isEdit" rows="4" v-decorator="['situationDescription', {initialValue: formModal.situationDescription}]"></a-textarea>
                </a-form-item>
            </a-col>
            <a-col :span="24" style="marginTop:20px">
                <a-form-item label="处理方式" v-bind="formItemLayout2">
                    <a-textarea :read-only="!formModal.isEdit" rows="4" v-decorator="['solution', {initialValue: formModal.solution}]"></a-textarea>
                </a-form-item>
            </a-col>
        </a-row>
        </a-form>
